...
public final class BarUtils {
    ...
    public static int getStatusBarHeight() {
        Resources resources = BaseUtils.getApp().getResources();
    ...
    public static int getActionBarHeight() {
        ...
        if (BaseUtils.getApp().getTheme().resolveAttribute(android.R.attr.actionBarSize, tv, true)) {
            return TypedValue.complexToDimensionPixelSize(
                    tv.data, BaseUtils.getApp().getResources().getDisplayMetrics()
            );
        }
        return 0;
    }
    ...
    private static void invokePanels(final String methodName) {
        try {
            ...
            Object service = BaseUtils.getApp().getSystemService("statusbar");
    ...
    public static int getNavBarHeight() {
        Resources res = BaseUtils.getApp().getResources();
    ...
    public static void setNavBarVisibility(@NonNull final Window window, boolean isVisible) {
        ...
        for (int i = 0, count = decorView.getChildCount(); i < count; i++) {
            ...
            if (id != View.NO_ID) {
                String resourceEntryName = BaseUtils.getApp()
                        .getResources()
    ...
    public static boolean isSupportNavBar() {
        ...
        boolean menu = ViewConfiguration.get(BaseUtils.getApp()).hasPermanentMenuKey();
    ...
    public static View getView(Activity activity, int bgResId) {
        View view = new View(activity);
        LinearLayout.LayoutParams layoutParams = new LinearLayout.LayoutParams(ViewGroup.LayoutParams.MATCH_PARENT, 1);
        view.setLayoutParams(layoutParams);
        view.setBackground(ContextCompat.getDrawable(activity, bgResId));
