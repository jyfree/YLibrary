    ...
    public static class Builder {
        ...
        private void setSpan() {
            ...
            if (imageIsBitmap || imageIsDrawable || imageIsUri || imageIsResourceId) {
                if (imageIsBitmap) {
                    mBuilder.setSpan(new CustomImageSpan(BaseUtils.getApp().getBaseContext(), bitmap, align), start, end, flag);
                    bitmap = null;
                    imageIsBitmap = false;
                    ...
                    mBuilder.setSpan(new CustomImageSpan(BaseUtils.getApp().getBaseContext(), uri, align), start, end, flag);
                    uri = null;
                    imageIsUri = false;
                } else {
                    mBuilder.setSpan(new CustomImageSpan(BaseUtils.getApp().getBaseContext(), resourceId, align), start, end, flag);
                    resourceId = 0;
        ...
        public Drawable getDrawable() {
            ...
            if (mDrawable != null) {
                ...
                try {
                    ...
                    YLogUtils.INSTANCE.e("sms", "Failed to loaded content " + mContentUri, e);
                }
            } else {
                try {
                    ...
                    YLogUtils.INSTANCE.e("sms", "Unable to find resource: " + mResourceId);
                }
            }
            return drawable;
        }
