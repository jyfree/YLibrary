...
/**
 * @description ViewBinding Fragment mvp模式基类
 * @date: 2021/4/19 10:07
 * @author: jy
 */
public abstract class MvpBaseVBFragment<VB extends ViewBinding, P extends BaseContract.BasePresenter> extends BaseVBFragment<VB> {
