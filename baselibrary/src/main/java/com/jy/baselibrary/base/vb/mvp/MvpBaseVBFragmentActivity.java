...
/**
 * @description ViewBinding FragmentActivity mvp基类
 * @date: 2021/4/19 10:10
 * @author: jy
 */
public abstract class MvpBaseVBFragmentActivity<VB extends ViewBinding, P extends BaseContract.BasePresenter> extends BaseVBFragmentActivity<VB> {
